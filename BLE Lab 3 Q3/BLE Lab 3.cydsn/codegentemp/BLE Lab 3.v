...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("01738078-6cdd-489f-9d51-172ab8bb61ef/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=true, Mode=1, OutputCurrent=0, Power=1, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=Opamp, )
...
module ADC_SAR_SEQ_P4_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("d8bc5745-1a94-48cf-8af3-9229c1e2285c/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    assign Net_1349 = 1'h0;


	cy_clock_v1_0
		#(.id("93f69760-d5bd-4e41-b484-fe9e4bf50629"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__HRI_net;
	wire [0:0] tmpFB_0__HRI_net;
	wire [0:0] tmpIO_0__HRI_net;
	wire [0:0] tmpINTERRUPT_0__HRI_net;
	electrical [0:0] tmpSIOVREF__HRI_net;

	cy_psoc3_pins_v1_10
		#(.id("4ea2909a-c04a-42e9-a5a6-bce2af98d0c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		HRI
		 (.oe(tmpOE__HRI_net),
		  .y({Net_2089}),
		  .fb({tmpFB_0__HRI_net[0:0]}),
		  .io({tmpIO_0__HRI_net[0:0]}),
		  .siovref(tmpSIOVREF__HRI_net),
		  .interrupt({tmpINTERRUPT_0__HRI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HRI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
